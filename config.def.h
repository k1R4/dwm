...
static const char col_cyan[]        = "#6a4da1";
...
const char *spcmd2[] = {"spotify-launcher", "--skip-update", NULL };
const char *spcmd3[] = {"brave", "--class=spbrave", NULL};
...
static const char *const autostart[] = {
	"sh", "-c", "~/.fehbg", NULL,
	"xinput", "set-prop", "10", "324", "-0.5", NULL,
	"eww", "daemon", NULL,
	"dwmblocks", NULL,
	"dunst", NULL,
...
static const Rule rules[] = {
	...
	{ NULL,     "spotify",	 NULL,	       SPTAG(1),   1,		   0,           0,        -1 },
	{ "spbrave",NULL,      NULL,	       SPTAG(2),   1,		   0,           0,        -1 },
...
static const char *dmenucmd[] = { "rofi", "-show", "drun", "-theme", "purple", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_a,      spawn,          SHCMD("~/.config/eww/armoury/launch") },
	{ MODKEY,                       XK_l,      spawn,          SHCMD("betterlockscreen -l dim") },
	...
	{ MODKEY,            			XK_j,	   togglescratch,  {.ui = 1 } },
	{ MODKEY,            			XK_k,	   togglescratch,  {.ui = 0 } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
